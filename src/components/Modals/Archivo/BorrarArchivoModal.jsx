...
export default function BorrarArchivoModal({ isOpen, onClose, onSubmit }) {
  const [archivoId, setArchivoId] = useState('');

  const handleSubmit = (e) => {
    e.preventDefault();
    if (onSubmit && archivoId.trim()) {
      onSubmit({ id: archivoId });
      setArchivoId('');
    }
  };
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body">
              ...
              <div className="form-group">
                <label htmlFor="archivoId">ID del Archivo a Eliminar *</label>
                <input
                  type="text"
                  id="archivoId"
                  value={archivoId}
