...
export default function ConfiguracionGeneralModal({ isOpen, onClose }) {
	const [config, setConfig] = useState({
		nombreSistema: 'Reuscons',
		email: 'admin@reuscons.com',
		tema: 'claro',
		lenguaje: 'es',
		...
		<div style={styles.overlay} onClick={onClose}>
			<div style={styles.modal} onClick={(e) => e.stopPropagation()}>
				...
				<form onSubmit={handleSubmit} style={styles.form}>
					...
					<div style={styles.formGroup}>
						<label style={styles.label}>Lenguaje:</label>
						<select
							name="lenguaje"
							value={config.lenguaje}
							onChange={handleChange}
							style={styles.select}
						>
					...
					<div style={styles.checkboxGroup}>
						<label style={styles.checkboxLabel}>
							<input
								...
								style={{ cursor: 'pointer' }}
							/>
							<span>Auto-guardado automático</span>
						</label>
					</div>
