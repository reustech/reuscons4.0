...
export default function ModificarTareaModal({ isOpen, onClose, onSubmit }) {
        ...
        <div className="modal-container" onClick={(e) => e.stopPropagation()}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body">
              ...
              <div className="form-group">
                <label htmlFor="columnId">ID Columna</label>
                <input
                  type="text"
                  id="columnId"
                  name="columnId"
              ...
              <div className="form-group">
                <label htmlFor="worksiteId">ID Obra</label>
                <input
                  type="text"
                  id="worksiteId"
                  name="worksiteId"
